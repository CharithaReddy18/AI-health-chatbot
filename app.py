...
#             box-shadow: 0 4px 24px 0 rgba(255,192,203,.12);
#         }
#         .user-bubble {
#             background: linear-gradient(90deg, #ffe4ec 60%, #f8bbd0 100%);
#             color: #d81b60;
#             padding: 12px 18px;
...
#             font-weight: 500;
#             font-size: 1.05rem;
#             box-shadow: 0 2px 8px 0 rgba(255,192,203,.10);
#         }
#         .bot-bubble {
...
#     st.markdown(
#         "<h1 style='text-align: center; color: #ad1457; margin-bottom: 30px;'>Healthcare Assistant Chatbot 💗</h1>",
#         unsafe_allow_html=True,
#     )
...
#     submit_clicked = col2.button("Submit")
#     if submit_clicked and user_input:
#         st.session_state.messages.append(("User", user_input))
#         with st.spinner("Processing your query..."):
#             response = healthcare_chatbot(user_input)
#         st.session_state.messages.append(("Healthcare Assistant", response))
#     elif submit_clicked and not user_input:
#         st.warning("Please enter a message to get a response.")

#     st.markdown(
#         "<div style='text-align:center; color: #ad1457; margin-top: 40px; font-size: 0.95rem;'>"
#         "⚠️ This chatbot provides general information and is not a substitute for professional medical advice.<br>"
...
def main():
    ...
    st.markdown(
        ...
        .chat-container {
            ...
            margin-bottom: 30px;
            border: 1px solid #f8bbd0;
            box-shadow: 0 8px 32px 0 rgba(255,192,203,.18);
        }
        .user-bubble {
            background: linear-gradient(90deg, #ffe4ec 60%, #f8bbd0 100%);
            color: #d81b60;
            ...
            font-weight: 500;
            font-size: 1.08rem;
            box-shadow: 0 2px 12px 0 rgba(255,192,203,.12);
        ...
        .stButton>button {
            background: linear-gradient(90deg, #d81b60 60%, #f8bbd0 100%);
            color: white;
            border-radius: 14px;
            padding: 10px 36px;
            font-size: 1.15rem;
    ...
    st.markdown(
        ...
        <div style='text-align: center; margin-bottom: 0px;'>
            <h1 style='color: #ad1457; font-size: 2.7rem; margin-bottom: 0;'>Healthcare Assistant Chatbot 💗</h1>
            <p style='color: #d81b60; font-size: 1.25rem; margin-top: 0;'>Your friendly health companion</p>
        </div>
        """,
        unsafe_allow_html=True,
    )
    ...
    user_input = st.text_input("Type your health query here...", key="input")
